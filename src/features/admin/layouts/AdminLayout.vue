  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col w-56 border-r border-gray-300">
      ...
      <div class="flex flex-col flex-grow p-4 overflow-auto">
        <RouterLink v-for="nav in navigation" :key="nav.label" :to="nav.to" class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300/60" href="#">
          <span class="leading-none">{{ nav.label }}</span>
        </RouterLink>
        <Button class="mt-auto" icon="plus" variant="secondary">
          New Product
        </Button>
      </div>
    </div>
    <div class="flex flex-col flex-grow">
      <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
        ...
        <!-- <Button class="ml-auto" variant="tertiary">
          Action 1
        </Button>
        <Button class="ml-2" variant="tertiary">
          Action 2
        </Button>
